...
# Labels and entries
tk.Label(root, text="Tên sách:").grid(row=0, column=0, padx=10, pady=5)
entry_title = tk.Entry(root)
entry_title.grid(row=0, column=1, padx=10, pady=5)

tk.Label(root, text="Tác giả:").grid(row=1, column=0, padx=10, pady=5)
entry_author = tk.Entry(root)
entry_author.grid(row=1, column=1, padx=10, pady=5)

tk.Label(root, text="Năm XB:").grid(row=2, column=0, padx=10, pady=5)
entry_year = tk.Entry(root)
entry_year.grid(row=2, column=1, padx=10, pady=5)

tk.Label(root, text="Thể loại:").grid(row=3, column=0, padx=10, pady=5)
entry_genre = tk.Entry(root)
entry_genre.grid(row=3, column=1, padx=10, pady=5)

# Buttons
tk.Button(root, text="Thêm sách", command=add_book).grid(row=4, column=0, padx=10, pady=10)
tk.Button(root, text="Cập nhật thông tin", command=update_book).grid(row=4, column=1, padx=10, pady=10)
tk.Button(root, text="Xóa sách", command=delete_book).grid(row=4, column=2, padx=10, pady=10)
tk.Button(root, text="Tải lại danh sách", command=reload_books).grid(row=4, column=3, padx=10, pady=10)
